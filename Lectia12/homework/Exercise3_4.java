...
public class Exercise3_4 {
    ...
    public static void main(String[] args) {
        ...
        Exercise3_4 ref3 = new Exercise3_4("Repesco",9.8); //
        ...
        Exercise3_4 ref4 = new Exercise3_4("Repesco","Vadim",9.8); //
